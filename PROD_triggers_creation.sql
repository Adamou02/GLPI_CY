...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_priority
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_status
BEFORE INSERT OR UPDATE ON GLPI_PROD.REF_status
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_category
BEFORE INSERT OR UPDATE ON GLPI_PROD.REF_category
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_type
BEFORE INSERT OR UPDATE ON GLPI_PROD.REF_type
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_role
BEFORE INSERT OR UPDATE ON GLPI_PROD.REF_role
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ref_group
BEFORE INSERT OR UPDATE ON GLPI_PROD.REF_group
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_locations
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_hardwares
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_users
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_tickets
BEFORE INSERT OR UPDATE ON GLPI_PROD.TICKETS
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_comments
BEFORE INSERT OR UPDATE ON GLPI_PROD.COMMENTS
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ressources
BEFORE INSERT OR UPDATE ON GLPI_PROD.RESSOURCES
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_ticket_ressources
BEFORE INSERT OR UPDATE ON GLPI_PROD.TICKET_RESSOURCES
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_comment_ressources
BEFORE INSERT OR UPDATE ON GLPI_PROD.COMMENT_RESSOURCES
FOR EACH ROW
BEGIN
    -- Vérifier si la valeur de fk_ressource existe dans la table RESSOURCES
    IF NOT CHECK_VALUE_EXIST(:NEW.fk_ressource, 'ressource_id', 'RESSOURCES') THEN 
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_observers
BEFORE INSERT OR UPDATE ON GLPI_PROD.OBSERVERS
FOR EACH ROW
BEGIN
    -- Vérifier si la valeur de fk_ticket existe dans la table TICKETS
    IF NOT CHECK_VALUE_EXIST(:NEW.fk_ticket, 'ticket_id', 'TICKETS') THEN 
...
CREATE OR REPLACE TRIGGER GLPI_PROD.trg_upsert_assigned_to
BEFORE INSERT OR UPDATE ON GLPI_PROD.ASSIGNED_TO
FOR EACH ROW
BEGIN
    -- Vérifier si la valeur de fk_ticket existe dans la table TICKETS
    IF NOT CHECK_VALUE_EXIST(:NEW.fk_ticket, 'ticket_id', 'TICKETS') THEN 
