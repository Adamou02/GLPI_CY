...
-- Supprimer le trigger pour la table COMMENT_RESSOURCES dans GLPI_PROD
DROP TRIGGER GLPI_PROD.trg_upsert_comment_ressources;

-- Supprimer le trigger pour la table COMMENT_RESSOURCES dans GLPI_TEST
DROP TRIGGER GLPI_TEST.trg_upsert_comment_ressources;

-- Supprimer le trigger pour la table OBSERVERS dans GLPI_PROD
DROP TRIGGER GLPI_PROD.trg_upsert_observers;

-- Supprimer le trigger pour la table OBSERVERS dans GLPI_TEST
DROP TRIGGER GLPI_TEST.trg_upsert_observers;

-- Supprimer le trigger pour la table ASSIGNED_TO dans GLPI_PROD
DROP TRIGGER GLPI_PROD.trg_upsert_assigned_to;

-- Supprimer le trigger pour la table ASSIGNED_TO dans GLPI_TEST
DROP TRIGGER GLPI_TEST.trg_upsert_assigned_to;
