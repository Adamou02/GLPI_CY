...
INSERT INTO GLPI_CERGY.LOCATIONS (location_id, "location", "site", city) VALUES (2, 'Building B, Basement', 'Site 2', 'City 2');
INSERT INTO GLPI_CERGY.LOCATIONS (location_id, "location", "site", city) VALUES (3, 'Building C, Floor 2', 'Site 3', 'City 3');
INSERT INTO GLPI_CERGY.LOCATIONS (location_id, "location", "site", city) VALUES (4, 'Warehouse', 'Site 4', 'City 4');
...
INSERT INTO GLPI_CERGY.USERS (user_id, fk_role, fk_group, "password", email ,last_name, first_name, company, fk_location) VALUES (1, 3, 3, 'Password1234???', 'Cc@gmail.com', 'Williams', 'Emily', '123 Industries', 1);
INSERT INTO GLPI_CERGY.USERS (user_id, fk_role, fk_group, "password", email ,last_name, first_name, company, fk_location) VALUES (2, 2, 2, 'Password1234???', 'Dd@gmail.com', 'Brown', 'Michael', '456 Corporation', 2);
INSERT INTO GLPI_CERGY.USERS (user_id, fk_role, fk_group, "password", email ,last_name, first_name, company, fk_location) VALUES (3, 1, 2, 'Password1234???', 'Ee@gmail.com', 'Jones', 'Jessica', '789 Enterprises', 3);
INSERT INTO GLPI_CERGY.USERS (user_id, fk_role, fk_group, "password", email ,last_name, first_name, company, fk_location) VALUES (4, 2, 1, 'Password1234???', 'Ff@gmail.com', 'Davis', 'Matthew', 'ABC Corp', 2);
INSERT INTO GLPI_CERGY.USERS (user_id, fk_role, fk_group, "password", email ,last_name, first_name, company, fk_location) VALUES (5, 3, 1, 'Password1234???', 'Gg@gmail.com', 'Taylor', 'Daniel', 'XYZ Ltd', 1);

-- Inserts supplémentaires pour TICKETS
INSERT INTO GLPI_CERGY.TICKETS (ticket_id, fk_created_by, fk_type, fk_priority, title, "description", fk_location, creation_datetime, last_modification_datetime, resolution_datetime, resolution_note, closing_datetime, fk_assigned_group, fk_status, fk_category, fk_hardwares) VALUES (1, 1, 1, 1, 'Software Update Request', 'Requesting update for Adobe Acrobat Reader.', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, 1, 2, 3, NULL);
...
INSERT INTO GLPI_CERGY.TICKETS (ticket_id, fk_created_by, fk_type, fk_priority, title, "description", fk_location, creation_datetime, last_modification_datetime, resolution_datetime, resolution_note, closing_datetime, fk_assigned_group, fk_status, fk_category, fk_hardwares) VALUES (19, 2, 1, 1, 'General Inquiry', 'Seeking information regarding CERGYuct pricing.', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, 2, 1, 3, NULL);

-- Inserts supplémentaires pour COMMENTS
INSERT INTO GLPI_CERGY.COMMENTS (comment_id, fk_answer_to, fk_ticket, fk_user, creation_datetime, task, "content") VALUES (1, NULL, 2, 1, CURRENT_TIMESTAMP, 'Request Details', 'Please ensure that the laPAU version of Adobe Acrobat Reader is installed.');
INSERT INTO GLPI_CERGY.COMMENTS (comment_id, fk_answer_to, fk_ticket, fk_user, creation_datetime, task, "content") VALUES (2, NULL, 3, 1, CURRENT_TIMESTAMP, 'Change Request Details', 'The new branch office is located in downtown area.');
INSERT INTO GLPI_CERGY.COMMENTS (comment_id, fk_answer_to, fk_ticket, fk_user, creation_datetime, task, "content") VALUES (3, NULL, 2, 1, CURRENT_TIMESTAMP, 'Training Details', 'The security training should cover basic awareness and best practices.');
INSERT INTO GLPI_CERGY.COMMENTS (comment_id, fk_answer_to, fk_ticket, fk_user, creation_datetime, task, "content") VALUES (4, NULL, 3, 2, CURRENT_TIMESTAMP, 'Access Issue Details', 'Error message indicates permission denied.');
...
INSERT INTO GLPI_CERGY.TICKET_RESSOURCES (fk_ressource, fk_ticket) VALUES (2, 1);
INSERT INTO GLPI_CERGY.TICKET_RESSOURCES (fk_ressource, fk_ticket) VALUES (3, 2);
INSERT INTO GLPI_CERGY.TICKET_RESSOURCES (fk_ressource, fk_ticket) VALUES (4, 2);
INSERT INTO GLPI_CERGY.TICKET_RESSOURCES (fk_ressource, fk_ticket) VALUES (5, 3);

-- Inserts supplémentaires pour COMMENT_RESSOURCES
INSERT INTO GLPI_CERGY.COMMENT_RESSOURCES (fk_ressource, fk_comment) VALUES (5, 1);
INSERT INTO GLPI_CERGY.COMMENT_RESSOURCES (fk_ressource, fk_comment) VALUES (5, 2);

-- Inserts supplémentaires pour OBSERVERS
INSERT INTO GLPI_CERGY.OBSERVERS (fk_ticket, fk_user) VALUES (2, 1);
INSERT INTO GLPI_CERGY.OBSERVERS (fk_ticket, fk_user) VALUES (3, 1);
INSERT INTO GLPI_CERGY.OBSERVERS (fk_ticket, fk_user) VALUES (4, 2);
INSERT INTO GLPI_CERGY.OBSERVERS (fk_ticket, fk_user) VALUES (5, 2);

-- Inserts supplémentaires pour ASSIGNED_TO
INSERT INTO GLPI_CERGY.ASSIGNED_TO (fk_ticket, fk_user) VALUES (2, 1);
INSERT INTO GLPI_CERGY.ASSIGNED_TO (fk_ticket, fk_user) VALUES (2, 2);
INSERT INTO GLPI_CERGY.ASSIGNED_TO (fk_ticket, fk_user) VALUES (3, 1);
INSERT INTO GLPI_CERGY.ASSIGNED_TO (fk_ticket, fk_user) VALUES (4, 1);
INSERT INTO GLPI_CERGY.ASSIGNED_TO (fk_ticket, fk_user) VALUES (5, 2);
