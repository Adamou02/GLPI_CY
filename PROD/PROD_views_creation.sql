...
JOIN GLPI_PROD.USERS ON TICKETS.fk_created_by = USERS.user_id
...
LEFT JOIN GLPI_PROD.ASSIGNED_TO ON TICKETS.ticket_id = GLPI_PROD.ASSIGNED_TO.fk_ticket
LEFT JOIN GLPI_PROD.USERS ASSIGNED_USERS ON GLPI_PROD.ASSIGNED_TO.fk_user = ASSIGNED_USERS.user_id
LEFT JOIN GLPI_PROD.HARDWARES ON TICKETS.fk_hardwares = GLPI_PROD.HARDWARES.hardware_id
LEFT JOIN GLPI_PROD.REF_group ON TICKETS.fk_assigned_group = GLPI_PROD.REF_group."group_id";
