...
INSERT INTO GLPI_TEST.REF_priority (priority_id, priority)
VALUES (1, 'Very low');
...
INSERT INTO GLPI_TEST.REF_status (status_id, status)
VALUES (1, 'To do');
...
INSERT INTO GLPI_TEST.REF_category (category_id, category)
VALUES (1, 'Hardware');
...
INSERT INTO GLPI_TEST.REF_type (type_id, type)
VALUES (1, 'Defect');
...
INSERT INTO GLPI_TEST.REF_role (role_id, role)
VALUES (1, 'Support');
...
INSERT INTO GLPI_TEST.REF_group (group_id, "group")
VALUES (1, 'IT Team');
...
INSERT INTO GLPI_TEST.LOCATIONS (location_id, location)
...
INSERT INTO GLPI_TEST.HARDWARES (hardware_id, name)
...
-- Inserts pour USERS
INSERT INTO GLPI_TEST.USERS (user_id, fk_role, fk_group, last_name, first_name, company, fk_location)
...
INSERT INTO GLPI_TEST.COMMENTS (
    comment_id, 
    fk_answer_to, 
    fk_ticket, 
    fk_user, 
...
INSERT INTO GLPI_TEST.RESSOURCES (ressource_id, fk_ticket, ressource)
VALUES (1, 1, 'Base64EncodedImageStringHere==');

-- Inserts pour TICKET_RESSOURCES
INSERT INTO GLPI_TEST.TICKET_RESSOURCES (fk_ressource, fk_ticket)
VALUES (1, 1);

-- Inserts pour COMMENT_RESSOURCES
INSERT INTO GLPI_TEST.COMMENT_RESSOURCES (fk_ressource, fk_comment)
VALUES (1, 1);

-- Inserts pour OBSERVERS
INSERT INTO GLPI_TEST.OBSERVERS (fk_ticket, fk_user)
VALUES (1, 2);

-- Inserts pour ASSIGNED_TO
INSERT INTO GLPI_TEST.ASSIGNED_TO (fk_ticket, fk_user)
VALUES (1, 1);
